...
export default class DenyTimesheet extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  onSubmit = (e) => {
    ...
    const timesdata = {
      ...
      empid: empid,
      emptimestatus: "Denied",
      emptcomment: emptcomment,
      _id: _id,
    };
    ...
    Swal.fire({
      text: "Timesheet has been denied",
    });
  };
    ...
    axios.get(`http://localhost:8400/emptimesheet/${timesid}`).then((res) => {
      if (res.data.success) {
        this.setState({
          ...
          emptcomment: res.data.emptimesheet.emptcomment,
    ...
    return (
      <div className="apprtime">
        ...
        <label
          ...
          class="form-label"
          id="empsheetid"
          style={{ textDecoration: "none", color: "#444040" }}
        >
